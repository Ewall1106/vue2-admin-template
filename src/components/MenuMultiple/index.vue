<template>
  <div class="menu-multiple">
    <div style="width: 256px; flex-shrink: 0; border-right: 1px solid #e6e6eb">
      <!-- level 1 -->
      <div class="submenu" v-for="(i, idx) in menuList" :key="idx">
        <div
          class="submenu-level-1"
          :class="i.isActive ? 'subMenuActive' : ''"
          @click="handleMenuClick(i, idx)"
        >
          <div>
            <i
              class="el-icon-arrow-down iconArrow"
              :class="i.isExpand ? 'iconExpand' : 'iconCollapse'"
            />
        ...
        <el-collapse-transition>
          <div v-show="i.isExpand">
            <div v-for="(j, idx) in i.children" :key="idx">
              <div class="submenu-level-2" @click="handleMenuClick(j, idx)">
                <i
                  class="el-icon-arrow-down iconArrow"
                  :class="j.isExpand ? 'iconExpand' : 'iconCollapse'"
                />
